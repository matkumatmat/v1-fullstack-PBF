...
// --- Tipe dan Fungsi Helper (ditaruh di luar komponen) ---
...
export default function FilteringTesting() { // <-- PROPS DIHAPUS, BALIK JADI SIMPEL
    ...
    React.useEffect(() => {
        // <-- LOGIKA onDataManipulated DIHAPUS, CUMA SET STATE LOKAL
    ...
    }, [locationDetails, allData]); // <-- DEPENDENCY ARRAY DISEDERHANAKAN
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader><CardTitle>1. Data Lookup Terpilih</CardTitle><CardDescription>Data ringan dari hasil filter pertama.</CardDescription></CardHeader>
                <CardContent><pre className="p-4 bg-muted rounded-md overflow-x-auto text-sm">{selectedLocation ? JSON.stringify(selectedLocation, null, 2) : "Belum ada lokasi yang dipilih."}</pre></CardContent>
            </Card>

            <Card>
                <CardHeader><CardTitle>2. Data Detail Lengkap Lokasi</CardTitle><CardDescription>Hasil fetch dari endpoint .</CardDescription></CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader><CardTitle>3. Hasil Manipulasi String</CardTitle><CardDescription>Objek JSON yang dihasilkan dari logika pemrosesan</CardDescription></CardHeader>
                <CardContent>
                    <pre className="p-4 bg-muted rounded-md overflow-x-auto text-sm">
                        {manipulatedData ? JSON.stringify(manipulatedData, null, 2) : "Pilih sebuah lokasi untuk melihat hasil manipulasi."}
                    </pre>
                </CardContent>
            </Card>      
        </div>
