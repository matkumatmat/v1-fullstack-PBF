...
// ================== PERBAIKAN 1: Skema Zod Diperbaiki ==================
const locationResponseSchema = z.object({
  public_id: z.string().uuid(),
  name: z.string().nullable(),
  city: z.string().nullable(),
  state_province: z.string().nullable(),
  // Menambahkan field alamat dan memperbaiki sintaks .nullable()
...
// Fungsi fetch (tidak ada perubahan)
                ...
                <div className="pl-6 space-y-2">
                  {branch.locations.map((location) => (
                    <div key={location.public_id} className="flex items-start gap-2 text-sm text-muted-foreground">
                      ...
                      {/* ================== PERBAIKAN 2: Tampilan Alamat Multi-baris ================== */}
