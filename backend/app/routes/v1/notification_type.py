...
def create_new_notification_type(
    notification_type: NotificationTypeCreate, db: Session = Depends(get_db)
):
...
def read_notification_type(notification_type_id: int, db: Session = Depends(get_db)):
...
def delete_existing_notification_type(
    notification_type_id: int, db: Session = Depends(get_db)
):
