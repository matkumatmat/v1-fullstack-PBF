...
def create_new_packaging_material(
    packaging_material: PackagingMaterialCreate, db: Session = Depends(get_db_session)
):
...
def read_packaging_material(packaging_material_id: int, db: Session = Depends(get_db_session)):
...
def delete_existing_packaging_material(
    packaging_material_id: int, db: Session = Depends(get_db_session)
):
