# file: app/schemas/type/packaging_box_type.py
...
class PackagingBoxTypeBase(TypeBase):
...
class PackagingBoxTypeCreate(TypeCreate, PackagingBoxTypeBase):
    pass

class PackagingBoxTypeUpdate(TypeUpdate):
...
class PackagingBoxType(TypeInDBBase, PackagingBoxTypeBase):
    pass