...
class _NotificationTypeCore(TypeBase):
...
class NotificationTypeFePl(TypeBase, _NotificationTypeCore, FePlBase):
    pass

class NotificationTypeFePlUpdate(TypeUpdate):
...
class NotificationTypeFeRes(_NotificationTypeCore, FeResBase, TypeBase):
    pass

class NotificationTypeFeResLookup(FeResLookup):
    pass

class NotificationTypeDb(_NotificationTypeCore, DbBase, TypeBase):
    is_active: Optional[bool] = None
    is_email_enabled: Optional[bool] = None
    is_sms_enabled: Optional[bool] = None
    is_push_enabled: Optional[bool] = None
